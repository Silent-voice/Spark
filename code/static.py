...
def _init():
    ...
    _global_dict = {
                    # 本地路径
                    'dns_data_dir_local_path' : '/home/hadoop/spark_code/code/data/dns',
                    'ssl_data_dir_local_path': '/home/hadoop/spark_code/code/data/ftp',
                    'ftp_data_dir_local_path': '/home/hadoop/spark_code/code/data/ftp',
